...
module RushJob
  class RushJobsHelperTest < ActionView::TestCase
    test 'sortable column' do
      assert_equal '<a class="link-dark" href="/rush_job/?direction=desc&amp;sort=id">Id</a>', sortable('id')
    end

    test 'sortable direction' do
      params[:direction] = 'desc'
      assert_equal '<a class="link-dark" href="/rush_job/?direction=asc&amp;sort=id">Id</a>', sortable('id')
    end
    ...
    test 'sort different column and direction' do
      ...
      assert_equal '<a class="link-dark" href="/rush_job/?direction=asc&amp;sort=priority">Priority</a>',
                   sortable('priority')
    end
    ...
    test 'sortable dark theme' do
      ...
      assert_equal '<a class="link-light" href="/rush_job/?direction=desc&amp;sort=id">Id</a>', sortable('id')
    end
